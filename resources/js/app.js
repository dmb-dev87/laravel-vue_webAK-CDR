...
Vue.component('relac-dashboard', require('./components/RelacDashboard.vue').default);
Vue.component('calsdis-dashboard', require('./components/CalsDisDashboard.vue').default);
/**
